...
namespace Api.Controllers
{
    ...
    public class ProdutosController : ControllerBase
    {
        ...
        [SwaggerResponse(206, "Conteúdo parcial!", typeof(IList<ProdutoResponse>))]
...
",
        ...
        public async Task<IActionResult> GetProdutos([FromQuery] ProdutoRequest filtro)
        {
        ...
        [SwaggerResponse(200, "Consulta executada com sucesso!", typeof(CategoriaResponse))]
        [SwaggerResponse(204, "Requisição concluída, porém não há dados de retorno!")]
        [SwaggerResponse(206, "Conteúdo parcial!", typeof(IList<CategoriaResponse>))]
        [SwaggerResponse(412, "Condição prévia dada em um ou mais dos campos avaliado como falsa.", typeof(ErrorValidacao))]
...
",
       Tags = new[] { "Produtos" }
        ...
        [Consumes("application/json")]
        public async Task<IActionResult> PostCliente([FromBody] PostProdutoRequest filtro)
        {
            return Ok();
        }
        #endregion
...
",
   Tags = new[] { "Produtos" }
        ...
        [Consumes("application/json")]
        public async Task<IActionResult> PatchCliente([FromRoute] ProdutoByIdRequest idProduto, [FromBody] PatchProdutoRequest filtro)
        {
            return Ok();
        }
        #endregion
